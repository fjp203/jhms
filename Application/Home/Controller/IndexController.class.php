...
//     			echo(count($arr));
    ...
    public function zclist(){
    	set_time_limit(0);
    	$zclist = M("zclist");
    	$post_fields="s0=&s1=%25u9655%25u6C7D%25u724C&s2=&s3=&s4=&s5=&s6=&s7=&s8=&s9=&s10=&s11=&s12=&s13=&s14=&s15=&s16=&s17=&s18=&s20=0&s28=0&s29=0&s_1=&ss_1=1&s_2=&ss_2=1&s_3=&ss_3=1&s_4=&ss_4=1&s_5=&ss_5=1&s_6=&ss_6=1&s_7=&ss_7=1&s_8=&ss_8=1&s_9=&ss_9=1&page=1&start=0&limit=2000";
    	
    	$url = "http://www.chinacar.com.cn/ggcx_new/search_json.asp?_dc=1463017240235";
    	...
    	$data1=curl_exec($ch);
//     	$data1 = iconv('gbk', 'utf8', $data1);
    	curl_close($ch);
     	echo $data1;

   
// 	$zz="/' width='82px' height='62px' onMouseOver=toolTip('http://img.chinacar.com.cn/clcppic/";
//     	$data1=iconv('gbk','utf-8',$data1);
    	$data1=htmlspecialchars(iconv('gbk','utf-8',$data1));
//      	$data1=preg_replace("/\<img src='/","",$data1);
//      	echo preg_replace($zz,"",$data1);
